...
OUTILS = {
    ...
    "suivige": {
        "nom": "SuiviGE",
        "description": "Suivi des confirmations CDF",
        "detail": "Individuel & Equipes - M13 a Veterans - Toutes armes",
        "script": os.path.join(BASE_DIR, "SuiviGE", "app.py"),
        "port": 5006,
        "icone": "\U0001F4DD",
        "couleur": "#1F6391",
        "type": "web",
        "cwd": os.path.join(BASE_DIR, "SuiviGE"),
    },
    "suivimaster": {
        "nom": "SuiviMaster",
